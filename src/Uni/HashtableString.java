...
public class HashtableString {
    public static void main(String[] args) {
        Hashtable<Integer, String> hashMap = new Hashtable<>(); //Синхронизиран и не допуска nulls
        hashMap.put(0, "John");
        hashMap.put(1, "Steve");
        hashMap.put(2, "Ana");
        hashMap.put(3, "Peter");
        ...
        Collection<String> coll = hashMap.values(); //Връща колекция от стойностите Values
